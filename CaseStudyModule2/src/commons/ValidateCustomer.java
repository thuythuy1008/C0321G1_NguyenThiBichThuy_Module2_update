...
public class ValidateCustomer {
    ...
    public static void checkBirthDay(String string) throws CustomerException {
    ...
    public static void genderException(String string) throws CustomerException {
    ...
    public static void idCardException(String string) throws CustomerException {
    ...
    public static void phoneNumberException(String string) throws CustomerException {
    ...
    public static void emailException(String string) throws CustomerException {
    ...
    public static void customerTypeException(String string) throws CustomerException {
    ...
    public static void addressException(String string) throws CustomerException {
        String regex = "^.*$";
        if (!string.matches(regex)) {
